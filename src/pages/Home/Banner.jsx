...
const Banner = () => {
    return (
        <div className="">
            <div className="bg-[#173bb7] h-[80vh] w-[75vw] text-white px-10 pt-10 md:px-20 md:pt-20 lg:px-20 lg:pt-20" alt="" data-aos="fade-up">
            ...
            <img className='bg-fixed lg:visible mr-0 -mt-96 h-[70vh] w-2/5 mx-auto' src={banner} alt="" data-aos="fade-down"/>
        </div>
    );
};
